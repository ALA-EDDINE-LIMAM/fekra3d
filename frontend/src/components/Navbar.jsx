              ...
              <div className="mt-4 pt-6 border-t border-slate-200 dark:border-white/10 pb-6">
                ...
                <div className="px-4 flex flex-col gap-5 text-sm text-slate-700 dark:text-slate-300">
                  ...
                  <div className="flex flex-col gap-3">
                    <a href="mailto:fekra3d.printing@gmail.com" className="hover:text-[#47d7c6] dark:hover:text-[#47d7c6] transition-colors flex items-center gap-3">
                      ...
                      fekra3d.printing@gmail.com
                    </a>
                    <a href="tel:+21655084823" className="hover:text-[#47d7c6] dark:hover:text-[#47d7c6] transition-colors flex items-center gap-3">
